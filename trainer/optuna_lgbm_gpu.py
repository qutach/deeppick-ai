...
def main():
    ap = argparse.ArgumentParser(description="Optuna GPU-hyperparameteroptimering för LGBMRanker (ranking)")
    ...
    try:
        ...
        if args.save_model:
            ...
            print(f"Saved tuned GPU model to {model_path} and params to /models/lgbm_ranker_optuna.json")

    except Exception as e:
        print(f"Optuna GPU tuning failed: {e}")
        sys.exit(1)
